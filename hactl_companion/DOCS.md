...
1. Add the custom repository in **Settings → Add-ons → Add-on Store → ⋮ → Repositories**:
   ```
   https://github.com/flapperdeflipper/addons
   ```
...
Vendored from [hemm-ems/hactl-companion](https://github.com/hemm-ems/hactl-companion) (upstream 2026.7.13); see [upstream releases](https://github.com/hemm-ems/hactl-companion/releases) and the local CHANGELOG for this fork's history.
